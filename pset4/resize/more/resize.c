...
int main(int argc, char *argv[])
{
    ...
    // determine old padding for scanlines and dimensions
    ...
    bi.biSizeImage = ((float)bi.biWidth * sizeof(RGBTRIPLE) + newpadding )  * abs(bi.biHeight) ;
    ...
    else
    {
        ...
        fseek(inptr, (skip*(oldWidth * 3 + oldpadding)), SEEK_CUR);
        }
    }
